...
Проверить сборку под требования: `npm run yx` — прогоняет заслонку загрузки,
выделение текста, контекстное меню, отсутствие внешних ссылок и обрезку
интерфейса на экране с «чёлкой».
