...
const RU: Dict = {
  ...
  'hud.fullscreenTitle': 'Во весь экран',
  'hud.fullscreenExitTitle': 'Выйти из полноэкранного режима',
  'hud.placeHint': 'Ставьте {b} — можно несколько подряд · ПКМ/Esc — закончить',
  'hud.placeHintTouch': 'Тапните по карте, чтобы поставить {b}. Можно несколько подряд',
  'hud.demolishHint': 'Кликните по своей постройке, чтобы снести · ПКМ/Esc — закончить',
  'hud.demolishHintTouch': 'Тапните по своей постройке, чтобы снести',
  ...
  'set.sound': 'Звук',
  'set.fullscreen': 'Полный экран',
  'set.fullscreenOn': 'Включить',
  'set.fullscreenOff': 'Выключить',
  'set.fullscreenFail': 'Браузер не разрешил полноэкранный режим',
  ...
  'shop.weaponCrate': '🗃 Сундук с оружием',
  'shop.demolish': '🧨 Снести постройку',
  'shop.demolishDesc': 'Вернёт половину цены и всё из силоса, слот освободится. Хранилище снести нельзя.',
  'shop.demolishBtn': 'Снести',
  'ev.demolished': '🧨 Снесено · +{n} 💰',
...
const EN: Dict = {
  ...
  'hud.fullscreenTitle': 'Fullscreen',
  'hud.fullscreenExitTitle': 'Leave fullscreen',
  'hud.placeHint': 'Place {b} — as many as you like · RMB/Esc — done',
  'hud.placeHintTouch': 'Tap the map to place {b}. Keep tapping for more',
  'hud.demolishHint': 'Click one of your buildings to tear it down · RMB/Esc — done',
  'hud.demolishHintTouch': 'Tap one of your buildings to tear it down',
  ...
  'set.fullscreenOn': 'Enter',
  'set.fullscreenOff': 'Leave',
  'set.fullscreenFail': 'The browser refused fullscreen',
  ...
  'shop.buildCount': '({n}/{max})',
  'shop.wallCount': '🧱 {n}/{max}',
  'shop.weaponCrate': '🗃 Weapon crate',
  'shop.demolish': '🧨 Tear a building down',
  'shop.demolishDesc': 'Half the price back plus whatever is in its silo, and the slot is free again. The vault stays.',
  'shop.demolishBtn': 'Demolish',
  'ev.demolished': '🧨 Torn down · +{n} 💰',
